...
HD_PWD='D:/Documents/Vivado/SAP_1_Copy/SAP_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sap_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sap_1.tcl -notrace
